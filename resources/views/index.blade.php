          ...
          <ul class="blog-list has-scrollbar">
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  <img src="{{asset('assets/images/blog-1.png')}}" alt="The Most Inspiring Interior Design Of 2021" class="w-100">
                </figure>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  <img src="{{asset('assets/images/blog-2.jpg')}}" alt="Recent Commercial Real Estate Transactions" class="w-100">
                </figure>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  <img src="{{asset('assets/images/blog-3.jpg')}}" alt="Renovating a Living Room? Experts Share Their Secrets"
                    class="w-100">
                </figure>
